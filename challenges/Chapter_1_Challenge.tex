...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sp_}\DecValTok{500}\NormalTok{_prices_tbl }\OperatorTok{%>%}\StringTok{ }\KeywordTok{glimpse}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{kmeans_mapper <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{center =} \DecValTok{3}\NormalTok{) \{}
\NormalTok{    stock_date_matrix_tbl }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{symbol) }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{kmeans}\NormalTok{(}\DataTypeTok{centers =}\NormalTok{ center, }\DataTypeTok{nstart =} \DecValTok{20}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
